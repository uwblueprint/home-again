...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center gap-xs bg-transparent p-0 text-foreground group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "",
