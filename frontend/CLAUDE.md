...
| Tables                                  | **Gap** — no shared `Table` yet; `data-display/ResourceList.tsx` covers list views                                               | Build a shared `ui/table.tsx` when a real data table is needed — do not inline `<table>` markup per page.        |
...
| Tabs / Furniture category tabs          | `ui/tabs.tsx`, `ui/furniture-category-tabs.tsx`                                                                                  |                                                                                                                  |
...
- The Figma design system: <https://www.figma.com/design/UbiTqO5G1WotmW4URVdGwh/Home-Again-Design-System>
