          ...
          <div
            className={cn(
              ...
              isEditingSubOptions
                ? "h-0"
                : hasSubSelections
                  ? "min-h-[28px] rounded-xl border border-neutral-300 bg-white px-3 py-2.5"
                  : "min-h-[28px]"
            )}
          >
              ...
              <div className="flex flex-wrap items-center gap-2">
                {subOptions.map((sub) => {
                  ...
                  return (
                    <span
                      key={sub.id}
                      className="inline-flex items-center justify-center gap-1 rounded-lg bg-muted px-3 py-1 text-sm font-medium leading-5 text-secondary-foreground"
                    >
        ...
        <div className="w-full animate-in fade-in-50">
          {subOptions?.length && (isEditingSubOptions || !hasSubSelections) ? (
            <div
              className={cn(
                "mb-3 px-3 py-2.5",
                hasSubSelections && "rounded-xl border border-neutral-300 bg-white"
              )}
            >
